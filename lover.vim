...
hi Number		ctermfg=172	        ctermbg=white		cterm=none
hi Char			guifg=#0000d0		guibg=#f5f5ff		gui=none
hi Char			ctermfg=172      	ctermbg=white		cterm=none
hi String		guifg=#0000d0		guibg=#f5f5ff		gui=none
hi String		ctermfg=208      	ctermbg=white		cterm=none
hi Boolean		guifg=#0000d0		guibg=#f5f5ff		gui=none
hi Boolean		ctermfg=172      	ctermbg=white		cterm=none
hi Constant		guifg=darkgreen		guibg=white			gui=none
hi Constant		ctermfg=172	        ctermbg=white		cterm=none
...
hi Comment		ctermfg=198      	ctermbg=white		cterm=none
hi Identifier	guifg=darkred		guibg=white			gui=none
hi Identifier	ctermfg=198			ctermbg=white		cterm=none
hi Function		guifg=darkmagenta	guibg=white			gui=none
hi Function		ctermfg=198			ctermbg=white		cterm=none
hi PreProc		guifg=blue      	guibg=white			gui=none
hi PreProc		ctermfg=196         ctermbg=white	    cterm=none
hi Type			guifg=darkred		guibg=white			gui=none
hi Type			ctermfg=198 	 	ctermbg=white		cterm=none
