...
if version >= 700
  hi CursorLine guibg=#3c3c3c ctermbg=235 cterm=none
...
hi Boolean      guifg=#89d958 ctermfg=65 gui=none
...
hi Statement 	guifg=#f2f1f0 ctermfg=209 gui=bold cterm=bold
hi Keyword		guifg=#d9c634 ctermfg=185 gui=none
hi Constant 	guifg=#d9c634 ctermfg=185 gui=none
hi Number		guifg=#89d958 ctermfg=65 gui=none
hi Special		guifg=#d9c634 ctermfg=209 gui=none
hi PreProc 		guifg=#faf4c6 ctermfg=209 gui=none
