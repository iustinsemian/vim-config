...
hi Statement guifg=#000000 ctermfg=161 gui=bold cterm=bold 
...
hi Label guifg=#000000 ctermfg=0 gui=bold cterm=bold
hi StorageClass guifg=#000000 ctermfg=0 gui=bold cterm=bold
hi Structure guifg=#000000 ctermfg=0 gui=bold cterm=bold
hi TypeDef guifg=#000000 ctermfg=0 gui=bold cterm=bold
" }}}
" {{{ Completion menus
...
" }}}
" {{{ Tabs (non-gui0
hi TabLine guifg=#404040 ctermfg=238 guibg=#dddddd ctermbg=188 gui=none 
hi TabLineFill guifg=#404040 ctermfg=238 guibg=#dddddd ctermbg=188 gui=none 
